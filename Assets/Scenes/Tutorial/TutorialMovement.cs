...
public class TutorialMovement : MonoBehaviour
{
    ...
    public void SetMoveX(bool b) {
        MoveX = b;
    }

    public void TeleportPlayer(float pos){
        MoveX = false;
        //body.position.Set(body.position.x+pos,body.position.y+pos, body.position.z);
        body.position = new UnityEngine.Vector3(pos, pos, body.position.z);
